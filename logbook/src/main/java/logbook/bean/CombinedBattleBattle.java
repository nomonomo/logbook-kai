 ...
 */
@Data
public class CombinedBattleBattle implements ICombinedBattle, ISortieHougeki, IFormation, IKouku,
        ISupport, IAirBaseAttack {

    private static final long serialVersionUID = -702740175162759260L;
