...
/**
 * 連合艦隊(6-5)
 * ICombinedEcBattleはIBattleを継承しているため、Serializableを継承している。
 */
@Data
public class CombinedBattleEcBattle implements ICombinedEcBattle, ISortieHougeki,
        IFormation, IKouku, ISupport, IAirBaseAttack {
